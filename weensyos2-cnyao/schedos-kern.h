...
typedef struct process {
	...
	int p_priority; //FOR EXERCISE 4A, its priority
	int p_counter; //FOR EXERCISE 4B
	int p_ntickets; //FOR EXERCISE 7, its number of lottery tickets
} process_t;

// typedef uint16_t lock_t; //CHUNNAN: LOCK TYPE
